...
from door_pull_env import DoorPullTaskEnv
import rospy
...
if __name__=='__main__':
    ...
    model_path = os.path.join(sys.path[0], '..', 'saved_models', 'door_pull', agent_p.name+'_noise'+str(args.noise), datetime.now().strftime("%Y-%m-%d-%H-%M"))
