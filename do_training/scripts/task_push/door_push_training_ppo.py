...
from door_push_env import  DoorPushTaskEnv
import rospy
...
if __name__=='__main__':
    ...
    model_dir = os.path.join(sys.path[0], '..', 'saved_models', 'door_push', agent.name+'_noise'+str(args.noise), datetime.now().strftime("%Y-%m-%d-%H-%M"))
    # paramas
