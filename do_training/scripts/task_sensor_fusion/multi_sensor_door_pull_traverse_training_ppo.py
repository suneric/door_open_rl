...
if __name__=='__main__':
    ...
    env = DoorPullAndTraverseTaskEnv(resolution=(64,64), cam_noise=args.noise, use_ft=True)
    dim_obs = (64,64,3)
    ...
    model_dir = os.path.join(sys.path[0], '..', 'saved_models', 'ms_door_pull_traverse', agent.name+'_noise'+str(args.noise), datetime.now().strftime("%Y-%m-%d-%H-%M"))
    # paramas
