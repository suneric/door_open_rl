...
from door_traverse_env import DoorTraverseTaskEnv
import rospy
...
if __name__=='__main__':
    ...
    model_path = os.path.join(sys.path[0], '..', 'saved_models',  'door_traverse', agent_p.name+'_noise'+str(args.noise), datetime.now().strftime("%Y-%m-%d-%H-%M"))
